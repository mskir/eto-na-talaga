...
public class screampaymentController {
...
private void pay2Gcash(ActionEvent event) {
    try {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/screamgcash.fxml"));
        Parent root = loader.load();
...
private void pay2Credit(ActionEvent event) {
    try {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/screamcredit.fxml"));
        Parent root = loader.load();
