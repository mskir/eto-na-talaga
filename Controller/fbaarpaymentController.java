...
public class fbaarpaymentController {
...
private void pay2Gcash(ActionEvent event) {
    try {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/fbaargcash.fxml"));
        Parent root = loader.load();
...
private void pay2Credit(ActionEvent event) {
    try {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/fbaarcredit.fxml"));
        Parent root = loader.load();
