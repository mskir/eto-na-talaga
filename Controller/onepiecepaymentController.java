...
public class onepiecepaymentController {
...
private void pay2Gcash(ActionEvent event) {
    try {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/onepiecegcash.fxml"));
        Parent root = loader.load();
...
private void pay2Credit(ActionEvent event) {
    try {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/onepiececredit.fxml"));
        Parent root = loader.load();
