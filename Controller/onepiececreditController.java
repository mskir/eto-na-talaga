...
public class onepiececreditController {
    @FXML
    ...
    public void toTicket(ActionEvent event) {
        ...
        String predefinedcvc = "1";
        String predefinedED = "1";
        ...
        if (enteredNumber.equals(predefinedNumber) &&
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/onepieceTix.fxml"));
